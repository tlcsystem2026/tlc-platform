...
$D="Y:\TLC-BOS\Downloads";$Name="TLC_BUILD030R1_CLEAN_TRUE_FULL.zip";$Zip=Join-Path $D $Name;$T=Join-Path $D "_TLC_BOOTSTRAP_030R1"
if(!(Test-Path $Zip)){throw "Package not found: $Zip"};if(Test-Path $T){Remove-Item $T -Recurse -Force}
