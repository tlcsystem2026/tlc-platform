...
from src.api.routes.tlc_customer_name_matching import router as tlc_customer_name_matching_router
from src.api.routes.tlc_customer_name_matching import page_router as tlc_customer_name_matching_page_router
app.include_router(tlc_customer_name_matching_router)
app.include_router(tlc_customer_name_matching_page_router)
...
from src.api.routes.tlc_access_control import router as tlc_access_control_router
app.include_router(tlc_access_control_router)
from src.api.routes.tlc_super_admin import router as tlc_super_admin_router
app.include_router(tlc_super_admin_router)
...
from src.api.routes.tlc_mfa_security import router as tlc_mfa_security_router  # TLC_MFA_SECURITY_AUDIT_R1
app.include_router(tlc_mfa_security_router)
...
from src.api.routes.tlc_bank_remitter_candidate import router as tlc_bank_remitter_candidate_router  # TLC_BANK_REMITTER_CANDIDATE_BATCH_R1
app.include_router(tlc_bank_remitter_candidate_router)
