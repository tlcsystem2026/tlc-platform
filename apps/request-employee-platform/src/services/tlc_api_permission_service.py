...
RULES: tuple[tuple[str, str, str, str], ...] = (
    ...
    ("POST", r"/api/customer-candidates/batches", "CUSTOMER_CANDIDATE", "EXECUTE"),
    ("POST", r"/api/customer-candidates/bulk-resolve", "CUSTOMER_CANDIDATE", "APPROVE"),
    ("POST", r"/api/customer-candidates/[^/]+/resolve", "CUSTOMER_CANDIDATE", "APPROVE"),
    ("POST", r"/api/customer-candidates/import\.csv", "CUSTOMER_CANDIDATE", "EDIT"),
    ("DELETE", r"/api/tlc-customers/[^/]+", "CUSTOMER_MASTER", "DELETE"),
    # TLC_BANK_REMITTER_CANDIDATE_PERMISSION_R1
    ("POST", r"/api/bank-remitter-candidates/batches", "BANK_CUSTOMER_MATCHING", "EXECUTE"),
    ("POST", r"/api/bank-remitter-candidates/[^/]+/resolve", "BANK_CUSTOMER_MATCHING", "APPROVE"),
...
BUSINESS_RULES: tuple[tuple[str, str, str], ...] = (
    ...
    (r"/customer-import-candidate-center", "CUSTOMER_CANDIDATE", "VIEW"),
    (r"/api/customer-candidates(?:/.*)?", "CUSTOMER_CANDIDATE", "AUTO"),
    ...
    (r"/bank-remitter-candidate-center", "BANK_CUSTOMER_MATCHING", "VIEW"),
    (r"/api/bank-remitter-candidates(?:/.*)?", "BANK_CUSTOMER_MATCHING", "AUTO"),
...
NAVIGATION_MODULES: dict[str, str] = {
    ...
    "/customer-import-candidate-center": "CUSTOMER_CANDIDATE",
    ...
    "/bank-remitter-candidate-center": "BANK_CUSTOMER_MATCHING",
