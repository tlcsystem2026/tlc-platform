...
MODULES=[("DASHBOARD","Dashboard"),("LEGAL_ENTITY_MASTER","法人主数据"),("USER_PERMISSION","人员与权限"),("SYSTEM_PARAMETER","系统参数"),("DATABASE_MAINTENANCE","数据库维护"),("CUSTOMER_MASTER","客户主数据"),("BANK_MASTER","银行与账户"),("REQUEST_BATCH","请求书导入Batch"),("REQUEST_FILE_REVIEW","文件核对Review"),("REQUEST_BUSINESS_REVIEW","请求书业务审核"),("FORMAL_SALES_LEDGER","正式销售台账"),("SALES_STATISTICS","销售统计"),("BANK_IMPORT","银行流水导入"),("BANK_CUSTOMER_MATCHING","银行客户匹配"),("RECEIVABLE","应收管理"),("CUSTOMER_RECONCILIATION","客户对账"),("MONTHLY_WORKFLOW","月度流程"),("MONTHLY_CLOSE","月结"),("OPERATIONAL_EXCEPTION","异常处理"),("AUDIT_LOG","操作日志")]
